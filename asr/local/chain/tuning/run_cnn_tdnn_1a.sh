...
graph_dir=$dir/graph_lmSmall
if [ $stage -le 16 ]; then
  # Note: it might appear that this $lang directory is mismatched, and it is as
  # far as the 'topo' is concerned, but this script doesn't read the 'topo' from
  # the lang directory.
  utils/mkgraph.sh --self-loop-scale 1.0 --remove-oov data/lang_test_lmSmall $dir $graph_dir
fi
...
if [ $stage -le 17 ]; then
  ...
  for decode_set in test_clean test_other; do
      ...
      steps/nnet3/decode.sh --acwt 1.0 --post-decode-acwt 10.0 \
          ...
          $graph_dir data/${decode_set}_hires $dir/decode_${decode_set}${decode_iter:+_$decode_iter}_lmSmall || exit 1
      ...
      steps/lmrescore_const_arpa.sh \
          ...
          data/${decode_set}_hires $dir/decode_${decode_set}${decode_iter:+_$decode_iter}_{lmSmall,lmLarge} || exit 1
      # steps/lmrescore_const_arpa.sh \
  ...
  for data in test_msr; do
    (
      ...
      steps/online/nnet3/decode.sh \
          ...
          $graph_dir data/${data} ${dir}_online/decode_${data}_lmSmall || exit 1
