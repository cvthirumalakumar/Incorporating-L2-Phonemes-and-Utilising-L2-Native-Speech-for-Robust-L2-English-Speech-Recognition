export KALDI_ROOT=/mnt/sd1/kaldi
...
export PATH=/mnt/sd1/kaldi/tools/python:${PATH}
export LIBLBFGS=/mnt/sd1/kaldi/tools/liblbfgs-1.10
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:-}:${LIBLBFGS}/lib/.libs
export SRILM=/mnt/sd1/kaldi/tools/srilm
